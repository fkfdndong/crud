    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/update-etudiant/<?php echo e($etudiant->id); ?>" class="btn btn-info">modifier</a>
                    <a href="/delete-etudiant/<?php echo e($etudiant->id); ?>" class="btn btn-danger">supprimer</a>
                </td>
            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\p6\resources\views/etudiant/liste.blade.php ENDPATH**/ ?>