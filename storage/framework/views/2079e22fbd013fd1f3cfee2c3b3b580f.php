...
<ul>
  ...
  <div class="mb-3">
   ...
   <div class="mb-3">
    ...
    <input type="text"  class="form-control" id="Prenom" name="prenom" value="<?php echo e($etudiants->prenom); ?>">
  </div>

  <div class="mb-3">
    <label for="Classe" class="form-label">Classe</label>
    <input type="text"  class="form-control" id="Classe" name="classe" value="<?php echo e($etudiants->classe); ?>">
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\example-app\resources\views/etudiant/update.blade.php ENDPATH**/ ?>